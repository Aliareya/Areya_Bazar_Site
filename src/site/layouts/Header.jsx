...
function Header() {
    ...
    return (
        <div className=" sticky top-0 mx-auto bg-white shadow-md">
        <header className=" !z-50 max-w-7xl mx-auto h-[70px] flex justify-between items-center  xl:px-10 lg:px-6 md:px-3 max-md:px-5 max-sm:px-3">
            <div className="">
