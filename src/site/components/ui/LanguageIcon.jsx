...
function LanguageIcon({myclass = null}) {
  ...
  // const setSiteLang = useSite((state) => state.setSiteLang);
  // const lang = useLanguageStore((state) => state.siteLang);
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {/* Dropdown */}
      <div
        className={`${lang === "fa" || lang === "ps" ? "right-0" :"right-0"} z-50 absolute  mt-2 w-40 border border-gray-200 bg-white shadow-lg rounded-md overflow-hidden transition-all duration-200 ${
