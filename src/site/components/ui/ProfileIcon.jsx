...
function ProfileIcon({ is_login }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {/* Dropdown */}
      <div
        className={`${lang === 'fa' || lang === 'ps' ? 'left-0' : "right-0"} absolute mt-2 w-56 border border-gray-200 bg-white shadow-lg rounded-xl overflow-hidden transition-all duration-200 ${open ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"
          }`}
      >
        {/* User Info */}
